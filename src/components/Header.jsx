    ...
    <>
      <div className="h-[80px] flex justify-between items-center px-[100px]">
        <div className="w-[140px] h-[62px]">
          ...
          <p className="font-bold text-[14.58px] leading-[21.87px] tracking-[4.2px]">
            DEMO STORE
          </p>
        </div>
        <div>
          <ul className="flex justify-center items-center gap-8 font-medium text-[16px] leading-5 font-inter">
